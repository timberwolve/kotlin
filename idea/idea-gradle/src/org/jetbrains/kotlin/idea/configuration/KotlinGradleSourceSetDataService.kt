...
fun configureFacetByGradleModule(
    ...
    with(kotlinFacet.configuration.settings) {
        implementedModuleNames = getImplementedModuleName(moduleNode, sourceSetName, ideModule.project)
...
private fun getImplementedModuleName(moduleNode: DataNode<ModuleData>, sourceSetName: String?, project: Project): List<String> {
